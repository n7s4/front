      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cart in cartInfoList" :key="cart.id">
          <li class="cart-list-con1">
            <input type="checkbox" name="chk_list" :checked="cart.isChecked" @change="updateChecked(cart,$even.target.change)"/>
          </li>
...
export default {
  ...
  computed: {
    ...
    isCartChecked() {
      ...
      return (
        this.cartInfoList.filter((item) => item.isCartChecked == "1").length ===
