    ...
    routes:[
        {
            ...
            children:[
                {
                    path:'/center/myorder',
                    component:()=>import('@/components/pages/Center/myOrder'),
                },
                {
                    path:'/center/grouporder',
                    component:()=>import('@/components/pages/Center/groupOrder'),
                },{
                    path:'/center',
        ...
        {
            path:'/paysuccess',
            component:()=>import('@/components/pages/PaySuccess'),
            meta:{show:true},
            name:'paysuccess'
        },
        {
            path:'/pay',
            component:()=>import('@/components/pages/Pay'),
            meta:{show:true},
            name:'pay',
        ...
        {
            path:'/trade',
            component:()=>import('@/components/pages/Trade'),
            meta:{show:true},
            name:'trade',
            beforeEnter (to, from, next) {
                // 去交易页面，必须是从购物车而来
        ...
        {
            path:'/shopcart',
            component:()=>import('@/components/pages/ShopCart'),
            meta:{show:true},
            name:'shopcart'
        },
        {
            path:'/addcarsuccess',
            component:()=>import('@/components/pages/addCartSuccess'),
            meta:{show:true},
            name:'addcarsuccess'
        },
        {
